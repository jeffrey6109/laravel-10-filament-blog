...
<head>
    ...
    <title>{{ $metaTitle ?: \App\Models\TextWidget::getTitle('title-widget') }}</title>
    <meta name="author" content="{{ \App\Models\TextWidget::getTitle('title-widget') }}">
    <meta name="description" content="{!! $metaDescription ?: \App\Models\TextWidget::getContent('title-widget') !!}">
    ...
    <header class="w-full container mx-auto">
        <div class="flex flex-col items-center py-12">
            <a class="font-bold text-gray-800 uppercase hover:text-gray-700 text-5xl" href="{{ route('home') }}">
               {{ \App\Models\TextWidget::getTitle('title-widget') }}
            </a>
